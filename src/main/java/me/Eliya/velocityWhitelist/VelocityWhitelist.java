...
public class VelocityWhitelist {
    ...
    public void onProxyInitialization(ProxyInitializeEvent event) {
        ...
        WhitelistCMD command = new WhitelistCMD(configProperties);
        commandManager.register(commandManager.metaBuilder("vwhitelist").build(), command);
        commandManager.register(commandManager.metaBuilder("maintenance").build(), command);
